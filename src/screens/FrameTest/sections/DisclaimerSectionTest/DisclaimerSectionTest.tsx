    ...
    <section className="w-full bg-gray-100 py-12 md:py-16">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="bg-white rounded-lg p-6 md:p-8 shadow-sm">
          <h2 className="font-bold text-xl md:text-2xl text-[#091626] mb-6 font-['Montserrat',Helvetica] text-left">
            Disclosures & Disclaimers
          </h2>

          <div className="space-y-6 text-sm md:text-base font-['Roboto',Helvetica] text-[#222125] leading-[20px] md:leading-[24px] text-left">
            <div>
              <h3 className="font-bold text-lg text-[#091626] mb-2 text-left">Legal Professional Responsibility</h3>
              <p>
            ...
            <div>
              <h3 className="font-bold text-lg text-[#091626] mb-2 text-left">*Contingency Fee Disclosure</h3>
              <p>
            ...
            <div>
              <h3 className="font-bold text-lg text-[#091626] mb-2 text-left">No Guarantee of Results</h3>
              <p>
