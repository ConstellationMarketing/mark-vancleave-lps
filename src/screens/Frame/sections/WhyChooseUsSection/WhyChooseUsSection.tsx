    ...
    <section className="w-full py-20 bg-gradient-to-b from-white to-neutral-50">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#222125] font-['Montserrat',Helvetica] max-w-3xl mx-auto leading-[30px]">
        ...
        <div className="text-center bg-[#00417b] rounded-2xl p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a
              href="tel:2813038800"
              className="bg-[#d44600] hover:bg-[#c23900] text-white [font-family:'Roboto',Helvetica] text-[18px] tracking-[1px] rounded-none border-2 border-solid border-[#d44600] hover:border-[#c23900] px-8 pt-[20px] pb-[20px] transition-colors duration-300"
            >
