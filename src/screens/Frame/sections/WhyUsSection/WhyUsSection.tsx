    ...
    <section className="w-full py-8 md:py-12 bg-white">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-stretch">
          <div
            className="w-full lg:w-[415px] bg-[url(https://cdn.builder.io/api/v1/image/assets%2Fc8a7b33c1f3e4309983e45cabed92535%2Fde5539f813b34ff08ba4c025067ef7af?format=webp&width=800&height=1200)] bg-cover bg-center rounded-md shadow-lg"
            aria-hidden="true"
          />
          ...
          <div className="w-full lg:w-[653px] space-y-4 md:space-y-6 text-center lg:text-left">
            ...
            <Button
              className="bg-[#d44600] hover:bg-[#c23900] hover:border-[#c23900] text-white [font-family:'Roboto',Helvetica] text-[18px] tracking-[1px] rounded-none border-2 border-solid border-[#d44600] px-8 py-3 md:pt-[30px] md:pb-[30px] transition-colors duration-300 w-full lg:w-auto"
