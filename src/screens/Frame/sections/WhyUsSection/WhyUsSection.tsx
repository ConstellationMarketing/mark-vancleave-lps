      ...
      <div className="container mx-auto max-w-7xl px-4">
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-center">
          ...
          <div className="w-full lg:w-[653px] space-y-4 md:space-y-6 text-center lg:text-left">
            ...
            <Button
              className="bg-[#d44600] hover:bg-[#c23900] hover:border-[#c23900] text-white [font-family:'Roboto',Helvetica] text-[18px] tracking-[1px] rounded-none border-2 border-solid border-[#d44600] px-8 pt-[20px] pb-[20px] transition-colors duration-300 w-full lg:w-auto"
