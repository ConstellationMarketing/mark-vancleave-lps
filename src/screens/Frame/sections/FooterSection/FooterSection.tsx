          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div id="contact-form" className="bg-white rounded-lg p-6 md:p-8 shadow-xl">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-[#d44600] hover:bg-[#c23900] text-white [font-family:'Roboto',Helvetica] text-[18px] tracking-[1px] rounded-none border-2 border-solid border-[#d44600] hover:border-[#c23900] pt-[10px] pb-[10px] px-6 transition-colors duration-300"
                >
