    ...
    <section className="w-full bg-[#182246] py-8 md:py-16">
      <div className="container mx-auto max-w-4xl flex flex-col items-center justify-center gap-6 md:gap-8 px-4">
        ...
        <div className="text-center">
          ...
          >
            <span className="font-['Roboto',Helvetica] font-bold text-base md:text-lg lg:text-xl text-center leading-[24px] md:leading-[27px] lg:leading-[30.6px]">
        ...
        <div className="text-center mt-4 md:mt-6">
          <p className="font-['Roboto',Helvetica] font-medium text-base md:text-lg text-[#cbd5e0] text-center leading-[24px] md:leading-[27px]">
            Available 24/7 • Free Consultation • No Obligation
          </p>
          <p className="font-['Roboto',Helvetica] font-medium text-sm md:text-base text-white text-center leading-[20px] md:leading-[24px] mt-2">
